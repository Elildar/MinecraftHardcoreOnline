...
public class WorldGenTreesMho extends WorldGenTrees {

    private final int minTreeHeight;
	private final int[] woodIds;
	private final int[] leaveIds;
	
    public WorldGenTreesMho(boolean par1, int minTreeHeight, int[] woodIds, int[] leaveIds)
    {
        super(par1);
            ...
            else
            {
                ...
                if (isSoil && par4 < 256 - l - 1)
                {
                        ...
                        for (j2 = par3 - i2; j2 <= par3 + i2; ++j2)
                        {
                            ...
                            for (int l2 = par5 - i2; l2 <= par5 + i2; ++l2)
                            {
                                ...
                                if (Math.abs(k2) != i2 || Math.abs(i3) != i2 || par2Random.nextInt(2) != 0 && k1 != 0)
                                {
                                    ...
                                    {
                                        this.setBlockAndMetadata(par1World, j2, j1, l2, this.leaveIds[par2Random.nextInt(this.leaveIds.length)], 0);
                                    }
                                }
                            }
                        }
                    ...
                    for (j1 = 0; j1 < l; ++j1)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + j1, par5, this.woodIds[par2Random.nextInt(this.woodIds.length)], 0);
                        }
                    }
