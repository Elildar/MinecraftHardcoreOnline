...
public class ItemBlockStainedGlassPane extends ItemBlock {
	public ItemBlockStainedGlassPane(int par1)
	{
		super(par1);
	...
	{
		return Mho.metaVitrailPane.getIcon(2, par1);
	}
	...
	public String getItemNameIS(ItemStack is) //Get's the item incode name from an itemstack
	{
		...
		return "Vitrail plat" + types[is.getItemDamage()];
	}*/
}
