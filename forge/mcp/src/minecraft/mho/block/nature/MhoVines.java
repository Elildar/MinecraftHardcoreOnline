...
public class MhoVines extends Block implements IShearable
{
    public MhoVines(int par1, Material par3Material, String Name)
    {
        super(par1, par3Material);
        this.setTickRandomly(true);
		this.setCreativeTab(Mho.tabMhoNature);
