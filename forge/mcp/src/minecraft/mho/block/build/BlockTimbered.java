...
public class BlockTimbered extends Block {
	
	private Icon topIcon;
	private Icon faceIcon;
	
	public BlockTimbered(int par1, String name) {
    ...
    {
             this.topIcon = iconRegister.registerIcon(Mho.modid + ":timberedTop");
             this.faceIcon = iconRegister.registerIcon(Mho.modid + ":" + this.getTextureName());
    }
