...
public class MhoDoubleSlab extends BlockDirectional {
	
	private Icon faceIcon;
	private Icon topIcon;
	
	public MhoDoubleSlab(int ID, String Name) {
    ...
    public void registerIcons(IconRegister iconRegister)
    {
             ...
             this.faceIcon = iconRegister.registerIcon(Mho.modid + ":" + this.getTextureName()+"DoubleSlabFace");
    }
