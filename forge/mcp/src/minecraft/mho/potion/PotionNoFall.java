...
public class PotionNoFall extends ItemFood
{
    ...
    public PotionNoFall(int par1, int par2, boolean par4, String Name)
    {
    ...
    public PotionNoFall setAlwaysEdible()
    {
	...
	{
		l.add("Resistance a la chute - 1 minute");
	}
