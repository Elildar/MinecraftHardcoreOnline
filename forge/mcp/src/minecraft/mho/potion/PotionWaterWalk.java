...
public class PotionWaterWalk extends ItemFood
{
    ...
    public PotionWaterWalk(int par1, int par2, boolean par4, String Name)
    {
    ...
    public PotionWaterWalk setAlwaysEdible()
    {
	...
	{
		l.add("Marche sur eau - 3 minutes");
	}
