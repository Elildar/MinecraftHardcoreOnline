...
public class PotionLavaWalk extends ItemFood
{
    ...
    public PotionLavaWalk(int par1, int par2, boolean par4, String Name)
    {
    ...
    public PotionLavaWalk setAlwaysEdible()
    {
	...
	{
		l.add("Marche sur lave - 3 minutes");
	}
